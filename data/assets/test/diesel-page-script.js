...
const init=async()=>{
  try{
    ...
    if(currentCityData){
      ...
      updateEl("dieselPriceFAQ",`The ${FUEL_LABEL.toLowerCase()} price in ${CITY} is <strong>${price}</strong> per litre. Prices are updated daily at 6:00 AM IST.`,false);
