/* Fuel Price Script v1.5 - TBT Optimized */
!function(){"use strict";
...
h=()=>{
/* Start fetches immediately but process later */
const g=l(`https://cdn.frisqoo.com/${r}/${a}/${n}.json`);
const b=l(`https://cdn.frisqoo.com/${r}/${a}.json`);

/* Process when data arrives */
Promise.all([g,b]).then(([g,h])=>{
setTimeout(()=>{
const e=h.find((e,a)=>a>0&&e[0].trim().toLowerCase()===t.trim().toLowerCase());
if(e){
const[,a,n]=e,r=parseFloat(n.replace(/[^0-9.-]/g,"")),{arrow:s,color:i}=u(r);
p("paraPrice",a);
...
e.appendChild(l);
n+=r;
n<a.length&&setTimeout(s,v?15:5);
};
s();
...
requestIdleCallback(()=>{
Promise.all([l(`https://cdn.frisqoo.com/utilities/${r}/states.json`),l(`https://cdn.frisqoo.com/utilities/${r}/${a}.json`)]).then(([a,n])=>{
...
i+=o;
i<a.length&&setTimeout(h,v?30:15);
};
h();
